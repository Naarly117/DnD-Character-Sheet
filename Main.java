...
public class Main {
	...
	public static Character createNewCharacter() {
		...
		try {
			...
			File inFile = new File("storage/emulated/0/AppProjects/DnDCharacterSheet/src/initialProperties.txt");
	...
	public static Character executeCommand(String s, Character myCharacter) {
		...
		switch(s) {
			...
			case "printcharactersheet":
				...
				try {
					File fullCS = new File("/storage/emulated/0/AppProjects/DnDCharacterSheet/src/" + 
			...
			case "help":
				...
				try {
					File commands = new File("/storage/emulated/0/AppProjects/DnDCharacterSheet/src/commands.txt");
			...
			case "log":
				...
				try {
					File inFile = new File("/storage/emulated/0/AppProjects/DnDCharacterSheet/src/" 
			...
			case "newlog":
				...
				File log = new File("/storage/emulated/0/AppProjects/DnDCharacterSheet/src/" 
									+ myCharacter.getName().toLowerCase().replaceAll("\\s", "") + "/" 
									+ myCharacter.getName().toLowerCase().replaceAll("\\s", "") + "_log.txt");
				try {
	...
	public static Character loadCharacter(String name) {
		String path = "/storage/emulated/0/AppProjects/DnDCharacterSheet/src/";
		...
		try {
			...
			myCharacter = new Character(charData);
		} catch (FileNotFoundException e) {
	...
	public static void saveCharacter(Character myCharacter) {
